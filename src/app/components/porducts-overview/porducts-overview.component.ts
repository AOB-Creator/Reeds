  ...
  ngOnInit(): void {
    ...
    this.product_list = [
      ...
      },
      {
        ...
        description:
          'В отличие от типичных волнообразных и замысловатых текстур из тика, этот декор предельно прост. Дизайн выполнен со вкусом и гармонично, создавая удачный баланс между деревенским стилем и современностью. Идеально подходящий для мебельной тематики, этот декор представляет собой привлекательную альтернативу популярному варианту из дуба. Благодаря пористости и спокойным цветочным узорам этот материал имеет разнообразное применение. Утонченная рустикальность делает его отличным универсальным вариантом. дубу.',
        size: '750 x 1300 mm',
        where_to_use: 'Мебель',
        other_images: [
          'https://www.schattdecor.com/media/_processed_/9/4/csm_14-12607-003_a7d0a6ee8d.jpg',
